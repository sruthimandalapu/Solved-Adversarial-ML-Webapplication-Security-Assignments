...
namespace HandsOnTypeConversion
{
    class Demo6
    {
        static void Main()
        {
            ...
            long j = 32434324;
            double d = 23.34;
            object o1 = b; //boxing is implicit conversion
            object o2 = s;
            object o3 = i;
            object o4 = j;
            ...
            object o11 = 120;
            int k = (int)o11;//casting
            k=Convert.ToInt32(o11);
            double d1 = (double)o11; //convet object to double
            long l1 = (long)o11; //convert object to long
